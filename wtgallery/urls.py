...
urlpatterns = [
    ...
    path('photo_detail/<str:user_name>/<str:slug>', views.photo_detail, name='photo_detail'),
    path('video_detail/<str:user_name>/<str:slug>', views.video_detail, name='video_detail'),
